...
public void setLocation (int x, int y) {
	checkWidget ();
	setLocationInPixels(DPIUtil.autoScaleUp(x, parent.getZoomFactor()), DPIUtil.autoScaleUp(y, parent.getZoomFactor()));
}
...
public void setLocation (Point location) {
	...
	location = DPIUtil.autoScaleUp(location, parent.getZoomFactor());
