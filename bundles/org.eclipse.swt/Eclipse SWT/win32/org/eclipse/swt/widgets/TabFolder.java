...
Point minimumSize (int wHint, int hHint, boolean flushCache) {
	...
	for (Control child : _getChildren ()) {
		...
		if (index == count) {
			Rectangle rect = DPIUtil.autoScaleUp(child.getBounds (), getZoomFactor());
			 ...
			 */
			Point size = DPIUtil.autoScaleUp(child.computeSize (DPIUtil.autoScaleDown(wHint, getZoomFactor()), DPIUtil.autoScaleDown(hHint, getZoomFactor()), flushCache), getZoomFactor());
