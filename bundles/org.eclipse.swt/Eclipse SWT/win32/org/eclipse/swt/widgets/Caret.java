...
public void setBounds (int x, int y, int width, int height) {
	checkWidget();
	setBoundsInPixels(DPIUtil.autoScaleUp(x, getZoomFactor()), DPIUtil.autoScaleUp(y, getZoomFactor()), DPIUtil.autoScaleUp(width, getZoomFactor()), DPIUtil.autoScaleUp(height, getZoomFactor()));
}
...
public void setLocation (int x, int y) {
	checkWidget();
	setLocationInPixels(DPIUtil.autoScaleUp(x, getZoomFactor()), DPIUtil.autoScaleUp(y, getZoomFactor()));
}
...
public void setSize (int width, int height) {
	checkWidget();
	setSizeInPixels(DPIUtil.autoScaleUp(width, getZoomFactor()), DPIUtil.autoScaleUp(height, getZoomFactor()));
}
